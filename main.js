...
const translations = {
  ...
  ru: {
    "meta.homeTitle": "Muxtorjon | Портфолио",
    "meta.homeDescription": "Сайт-портфолио Muxtorjon, созданный на простой структуре HTML, CSS и JavaScript.",
    "meta.projectsTitle": "Muxtorjon | Проекты",
    "meta.projectsDescription": "Страница проектов Muxtorjon с фильтрацией и поиском.",
    "nav.home": "Главная",
    "nav.about": "Обо мне",
    "nav.skills": "Навыки",
    ...
    "controls.langRu": "Русский",
    "controls.theme": "Тема",
    "controls.dark": "Темная",
    "controls.light": "Светлая",
    "metrics.projects": "Всего проектов",
    "metrics.categories": "Категории проектов",
    "metrics.featured": "Избранные проекты",
    "filters.all": "Все",
    "filters.web": "Web",
    "filters.python": "Python",
    "filters.java": "Java",
    "filters.telegram": "Telegram",
    "home.heroEyebrow": "Главная страница портфолио",
    "home.heroTitle": "Портфолио отдельно, а проекты находятся на своей отдельной странице.",
    "home.heroText": "Главная страница теперь работает для вашего представления, навыков и контактов. Все проекты управляются, ищутся и фильтруются на отдельной странице.",
    "home.heroPrimary": "Открыть страницу проектов",
    "home.heroSecondary": "Связаться со мной",
    "home.setupLabel": "Текущая структура",
    "home.setupItem1": "Портфолио на одной основной странице",
    "home.setupItem2": "Проекты на отдельной странице",
    "home.setupItem3": "Все работает на одном CSS и одном JS файле",
    "home.aboutEyebrow": "Обо мне",
    "home.aboutTitle": "Простая структура, легкие обновления и чистая навигация.",
    "home.aboutText1": "С такой структурой портфолио и каталог проектов не смешиваются. Вы можете отдельно управлять дизайном портфолио и списком проектов.",
    "home.aboutText2": "Данные проектов по-прежнему хранятся в <strong>data/projects.json</strong>, поэтому добавлять новые работы по-прежнему легко.",
    "home.aboutCard1Title": "Чистое портфолио",
    "home.aboutCard1Text": "Главная страница знакомит посетителя с вами.",
    "home.aboutCard2Title": "Отдельные проекты",
    "home.aboutCard2Text": "Все работы показаны на отдельной странице.",
    "home.aboutCard3Title": "Легкое редактирование",
    "home.aboutCard3Text": "Фронтенд по-прежнему управляется из 3 основных файлов.",
    "home.skillsEyebrow": "Навыки",
    "home.skillsTitle": "Инструменты и сильные стороны, стоящие за вашими работами.",
    "home.skillHtml": "HTML и семантическая структура",
    "home.skillCss": "CSS и адаптивный дизайн",
    "home.skillJs": "Интерактивность на JavaScript",
    "home.skillNode": "Основы backend на Node.js",
    "home.skillsCardEyebrow": "Страница проектов",
    "home.skillsCardTitle": "Как работает отдельная страница проектов",
    "home.skillsCardItem1": "Все проекты загружаются из <strong>data/projects.json</strong>",
    "home.skillsCardItem2": "Фильтры и поиск работают на отдельной странице проектов",
    "home.skillsCardItem3": "Портфолио остается чистым для личного брендинга",
    "home.previewEyebrow": "Страница проектов",
    "home.previewTitle": "Проекты больше не находятся внутри портфолио, у них есть отдельная страница.",
    "home.previewText": "На отдельной странице все ваши работы можно просматривать через фильтры, поиск и карточки. Портфолио остается аккуратным и компактным.",
    "home.previewPrimary": "Перейти к проектам",
    "home.previewSecondary": "Заказать сайт",
    "home.contactEyebrow": "Контакты",
    "home.contactTitle": "Отправьте детали проекта прямо со страницы портфолио.",
    "home.contactText": "Если backend Node запущен, эта форма сохранит сообщения. Если нет, страница все равно работает как статический frontend и показывает, что backend офлайн.",
    "home.contactGithub": "GitHub",
    "home.contactProjectsPage": "Страница проектов",
    "home.contactApiStatus": "Статус API",
    "home.formName": "Имя",
    "home.formNamePlaceholder": "Ваше полное имя",
    "home.formEmail": "Email",
    "home.formEmailPlaceholder": "you@example.com",
    "home.formProjectType": "Тип проекта",
    "home.formTypePortfolio": "Сайт-портфолио",
    "home.formTypeLanding": "Лендинг",
    "home.formTypeBusiness": "Бизнес-сайт",
    "home.formTypeCustom": "Индивидуальный проект",
    "home.formMessage": "Сообщение",
    "home.formMessagePlaceholder": "Расскажите о сайте, нужных функциях или сроках...",
    "home.formSubmit": "Отправить сообщение",
    "projects.heroEyebrow": "Отдельная страница проектов",
    "projects.heroTitle": "Все ваши проекты в одном специальном месте.",
    "projects.heroText": "Эта страница только для проектов. Здесь вместе работают избранные карточки, фильтры по категориям и поиск.",
    "projects.heroPrimary": "Посмотреть проекты",
    "projects.heroSecondary": "Начать проект",
    "projects.featuredEyebrow": "Избранные работы",
    "projects.featuredTitle": "Выделенные проекты из источника данных.",
    "projects.loadingFeatured": "Загрузка избранных проектов...",
    "projects.explorerEyebrow": "Каталог проектов",
    "projects.explorerTitle": "Просматривайте все проекты с помощью фильтров и поиска.",
    "projects.searchLabel": "Поиск проектов",
    "projects.searchPlaceholder": "Ищите по названию, технологии или статусу",
    "projects.filteredEyebrow": "Отфильтрованные результаты",
    "projects.matchingProjects": "подходящих проектов",
    "projects.loadingAll": "Загрузка проектов...",
    "projects.backEyebrow": "Назад в портфолио",
    "projects.backTitle": "Страница портфолио остается отдельной, а контакты остаются там.",
    "projects.backText": "Если клиент или посетитель хочет узнать о вас, он возвращается на страницу портфолио. Если он хочет увидеть ваши работы, он остается на этой специальной странице.",
    "projects.backPrimary": "Открыть портфолио",
    "projects.backSecondary": "Раздел контактов",
    "projects.footerPage": "Страница проектов: projects.html",
    "projects.allProjects": "Все проекты",
    "projects.resultWord": "проекты",
    "footer.files": "Основные frontend файлы: index.html, style.css, main.js",
    "footer.rights": "Все права защищены.",
    "overlay.eyebrow": "Первый визит",
    "overlay.title": "Подпишитесь на наш YouTube канал",
    "overlay.text": "Чтобы не пропускать новые уроки, edit-видео и полезный контент, подпишитесь на канал <strong>j_edit-b5</strong>.",
    "overlay.subscribe": "Подписаться",
    "overlay.dismiss": "Войти в портфолио",
    "overlay.hint": "Этот экран показывается только при первом посещении.",
    "project.noFeatured": "Пока нет избранных проектов.",
    "project.noMatch": "По этому фильтру проекты не найдены.",
    "project.dataUnavailable": "Не удалось загрузить данные проектов.",
    "project.listUnavailable": "Не удалось загрузить список проектов.",
    "project.linkDemo": "Демо",
    "project.linkRepo": "Репозиторий",
    "project.linkTutorial": "Урок",
    "project.linksSoon": "Ссылки скоро появятся",
    "status.live": "Активен",
    "status.inProgress": "В процессе",
    "status.comingSoon": "Скоро",
    "status.ready": "Готово",
    "system.apiOnline": "Backend онлайн - загружено {count} проектов",
    "system.staticMode": "Статический режим - загружено {count} проектов",
    "system.dataUnavailable": "Данные недоступны",
    "system.sending": "Сообщение отправляется...",
    "system.sendingButton": "Отправка...",
    "system.sendSuccess": "Ваше сообщение успешно отправлено.",
    "system.backendOffline": "Backend не запущен. Frontend работает, но для сохранения формы нужен node server.js.",
    "system.errorRequired": "Имя, email и сообщение обязательны.",
    "system.errorEmail": "Пожалуйста, введите корректный email.",
    "system.errorSend": "Не удалось отправить сообщение."
  }
};
